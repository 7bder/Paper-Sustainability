...
\Author{Qi Chen $^{1,}$\orcidA{}, Siting Chen $^{2,}$, Go Higuchi $^{3,}$, and Shichen Zhao $^{4,}$*}

% Authors, for metadata in PDF
\AuthorNames{Qi Chen, Siting Chen, Go Higuchi and Shichen Zhao}

% Affiliations / Addresses (Add [1] after \address if there is only one affiliation.)
\address{%
	$^{1}$ \quad Graduate School of Human-Environment Studies, Kyushu University, Japan; chenqi.clever@gmail.com\\
	$^{2}$ \quad Graduate School of Human-Environment Studies, Kyushu University, Japan; miche.siz92@gmail.com\\
	$^{3}$ \quad Graduate School of Human-Environment Studies, Kyushu University, Japan; goooooooooo217@gmail.com\\
	$^{4}$ \quad Faculty of Human-Environment Studies, Kyushu University, Japan; zhao@arch.kyushu-u.ac.jp
}

% Contact information of the corresponding author
\corres{Correspondence: zhao@arch.kyushu-u.ac.jp}
...
\begin{figure}[h]
	...
	\centering
	\fbox{\includegraphics[width=0.6\linewidth]{StationDistribution}}
\end{figure}
...
\begin{figure}[h]
	...
	\centering
	\fbox{\includegraphics[width=0.6\linewidth]{DataCleaning}}
\end{figure}
...
\begin{figure}[h]
	...
	\centering
	\fbox{\includegraphics[width=0.6\linewidth]{AgeDistribution}}
\end{figure}
...
\begin{figure}[h]
	...
	\centering
	\fbox{\includegraphics[width=0.6\linewidth]{DurationDistribution}}
\end{figure}
...
\begin{figure}[h]
	...
	\centering
	\fbox{\includegraphics[width=0.6\linewidth]{RandomForests}}
\end{figure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\authorcontributions{Qi Chen conceived and designed the research framework, analyzed the data, and developed the method. Go Higuchi provided support in data curation. Siting Chen wrote parts of the original draft and revised the whole paper. Shichen Zhao provided all the resource necessary during the research and had been controlling the research direction all along.}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\acknowledgments{This study is finished during the author's doctoral period, the financial support from China Scholarship Council (CSC) is gratefully acknowledged.}
...
\begin{thebibliography}{999}
	...
	\bibitem[\protect\citeauthoryear{}{Levinson and
		Kumar}{1997}]{levinson1997density}
